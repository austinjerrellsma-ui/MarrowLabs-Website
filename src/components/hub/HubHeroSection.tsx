  ...
  return (
    <section className="relative flex min-h-[60vh] flex-col items-center justify-center overflow-hidden px-6 pt-32 pb-20 text-center">
      <div
        ...
        style={{
          background: `radial-gradient(ellipse 80% 60% at 50% 0%, rgb(var(--hub-glow) / 0.14), transparent)`,
        }}
      />
      <motion.div
      ...
      >
        <div className="mb-6 flex items-center justify-center gap-3">
          ...
          >
            <Monitor size={22} className={p.accentClass} />
          </div>
          <SectionLabel variant="hub">Desktop App</SectionLabel>
        </div>
        <h1 className="font-display text-5xl font-bold leading-tight tracking-tight sm:text-6xl">
          <GradientText variant="hub">MarrowLink Hub</GradientText>
        </h1>
